...
export default function InstituteStatisticsChart() {
  ...
  const series = [
    {
      name: "Students",
      data: [280, 310, 265, 290, 320, 285, 305, 340, 365, 355, 380, 395],
    },
    {
      name: "Articles",
      data: [45, 52, 48, 55, 62, 58, 65, 72, 78, 85, 90, 95],
    },
  ];
      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          ...
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Students enrolled and articles published over time
          </p>
        </div>
