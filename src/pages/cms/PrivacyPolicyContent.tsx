...
const defaultContent = {
  ...
  body: "Your privacy is important to us. This policy outlines how we collect, use, and protect your information.",
};
...
export default function PrivacyPolicyContent() {
  ...
  return (
    <>
      <PageMeta
        title="Privacy Policy Content | StudyCafe Admin"
        description="Update Privacy Policy content for studycafe.in"
      />
